...
def validate_digits_letters(word, field_title):
    print(word,field_title)
    for char in word:
...
def account_edit_view(request):
    ...
    return render(request, 'accounts/account_edit.html', template_dict)
...
def signup(request):
    ...
    return render(request, "registration/signup.html", template_dict)
...
def validate_form_password(password):
    try:
